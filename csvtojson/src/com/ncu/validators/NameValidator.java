...
public class NameValidator{
	public boolean nameValidator(String filename, String filetype){
		...
		String csvfilepath = "C:\\Users\\Aarushi\\Desktop\\csvtojson\\csvs";
		String jsonfilepath = "C:\\Users\\Aarushi\\Desktop\\csvtojson\\jsons";

		Logger logger = Logger.getLogger(NameValidator.class);
		PropertyConfigurator.configure("C:\\Users\\Aarushi\\Desktop\\csvtojson\\configs\\logger\\logger.properties");

		try{
			input = new FileInputStream("C:\\Users\\Aarushi\\Desktop\\csvtojson\\configs\\constants\\exceptions.properties");	
			prop.load(input);
